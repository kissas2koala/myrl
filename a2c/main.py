...
def main(params):
    ...
    RL = A2C(dim_obs=n_states, dim_act=n_actions, actor_lr=params.actor_lr, critic_lr=params.critic_lr,
             gamma=params.gamma, hidden_size=params.hidden_size)
